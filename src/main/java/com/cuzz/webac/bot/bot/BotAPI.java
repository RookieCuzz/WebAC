package com.cuzz.webac.bot.bot;
import com.cuzz.webac.bot.objects.ApiAction;
import com.cuzz.webac.bot.objects.contact.*;
import com.cuzz.webac.bot.objects.info.*;
...
import com.cuzz.webac.bot.objects.info.group.GroupSystemMessage;
import com.cuzz.webac.bot.objects.info.honer.GroupHonerInfo;
import com.cuzz.webac.bot.objects.info.ocr.ImageOCR;
import com.cuzz.webac.bot.objects.info.status.BotStatus;
import com.cuzz.webac.bot.objects.message.EssenceMessage;
import com.cuzz.webac.bot.objects.message.ForwardMessage;
import com.cuzz.webac.bot.objects.message.Image;
...
public class BotAPI {
    ...
    public void sendRawMsg(String msg) {
        nettyWebSocketServerHandler.send(msg);
    }
...
//        int timeout = AmazingBot.getInstance().getConfig().getInt("main.timeout");
        ...
        return nettyWebSocketServerHandler.send(data, timeout);
    }
    ...
    public void setBind(Long userID, UUID uuid) {
        System.out.println("set Bind 方法");
//        if (MySQL.ENABLED) {
...
//        AmazingBot.getData().save();
    ...
    public UUID getPlayer(Long userID) {
        System.out.println("getPlayer方法");
        return null;
    }
